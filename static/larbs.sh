#!/bin/sh
# Ayham's Auto Rice Bootstrapping Script (AARBS)
...
dotfilesrepo="https://github.com/ayham291/dotfiles.git"
progsfile="https://raw.githubusercontent.com/ayham291/AARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Ayham's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Ayham" 10 60
